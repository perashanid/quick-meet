...
interface EndMeetingEarlyConfirmationViewProps {
...
export default function EndMeetingEarlyConfirmationView({ event, open, handleNegativeClick, handlePositiveClick }: EndMeetingEarlyConfirmationViewProps) {
  if (!open) return <></>;
    ...
    >
      ...
      >
        ...
        <Typography variant="body1" sx={{ mt: 2, color: 'text.secondary' }}>
          This will set the end time to now and release the room for others to use.
        </Typography>
        {event && (
          <Box
            sx={{
